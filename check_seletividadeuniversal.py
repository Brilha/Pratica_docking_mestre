...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python3 preparar_arquivos.py <pasta_projeto>")
        sys.exit()
    ...
    if pdb_file:
        ...
        clean_pdb = os.path.join(pasta, "receptor_tmp.pdb") # Temporário
        ...
        # Remove o temporário pra não sujar a pasta
        if os.path.exists(clean_pdb): os.remove(clean_pdb)
