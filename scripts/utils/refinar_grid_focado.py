...
def gerar_grid_universal(pasta_projeto, res_inicio, res_fim):
    ...
    # ✅ NOVO (28/Jan): Criar flag para indicar que docking preciso foi usado
    # Isso permite que analisar_interacoes.py use melhor_pose em vez de primeiro resultado
    ...
    log(f"📌 Flag criado: .docking_preciso (complexo final usará melhor_pose)")
